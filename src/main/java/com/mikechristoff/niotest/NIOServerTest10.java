...
public class NIOServerTest10 {
	...
	static {
		...
		logger = LoggerFactory.getLogger(NIOServerTest10.class);	
	}	
	...
	private static void read(SelectionKey key) throws IOException {
		...
		if(read == -1) {
			...
			// We must close the channel after reading -1
			// otherwise we enter an infinite loop with the
			// selector endlessly telling us there is a last
			// bit of data left in the SocketChannel
			sc.close();
